...
The output format of reasoning process and final answer are enclosed within <think> </think> and <answer> </answer> tags. For example, <answer> Beijing </answer>.
...
def run(
    ...
    with open(output_jsonl_path, 'w', encoding='utf-8') as f:
        for idx, example in tqdm(enumerate(raw_data), desc="Generating"):
            ...
            # inputs_prepared = trainer._prepare_inputs(inputs)  
            print("准备写入*******************************************")
            # 取出completion
...
if __name__ == "__main__":
    ...
    result_path='./result/qwen_base'
    checkpoint_path='../checkpoints/qwen_base_v1'
